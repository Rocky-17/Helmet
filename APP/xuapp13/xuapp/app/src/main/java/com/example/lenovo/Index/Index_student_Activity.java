...
public class Index_student_Activity extends AppCompatActivity {
    ...
    private TextView fast_entrance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_index_student_);

        editText1=findViewById(R.id.m_edit1);
        editText2=findViewById(R.id.m_edit2);
        button=findViewById(R.id.btn_m_signup);//登录
        textView1=findViewById(R.id.btn_m_register);//注册信息
        textView2=findViewById(R.id.btn_change1);//跳转到教师端

        fast_entrance = findViewById(R.id.fast_entrance);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.isEmpty()|| passwd.isEmpty()){
                    ...
                    Intent intent=new Intent(Index_student_Activity.this,HomePageActivity.class);//跳转至学生端
        ...
        textView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Index_student_Activity.this,Index_teacher_Activity.class);
                startActivity(intent);
            }
        });

        fast_entrance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Index_student_Activity.this,HomePageActivity.class);
                startActivity(intent);
            }
        });
